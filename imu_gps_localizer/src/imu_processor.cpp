...
void ImuProcessor::Predict(const ImuDataPtr last_imu, const ImuDataPtr cur_imu,
	...
	state->cov =
	    Fx * last_state.cov * Fx.transpose() + Fi * Qi * Fi.transpose();
